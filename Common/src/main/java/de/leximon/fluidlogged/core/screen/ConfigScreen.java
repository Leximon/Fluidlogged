...
public class ConfigScreen extends Screen {
    ...
    private static final List<FormattedCharSequence> COMPATIBILITY_MODE_TOOLTIP = Minecraft.getInstance().font.split(
            new TranslatableComponent("fluidlogged.config.compatibilityMode.tooltip"),
            200
    );
    ...
    public ConfigScreen(Screen parent) {
        super(new TranslatableComponent("fluidlogged.config.title"));
        this.parent = parent;
    ...
    protected void init() {
        ...
        int space = 24;
        warningText = font.split(new TranslatableComponent("fluidlogged.config.warning"), (int) (width * 0.8));

        addRenderableWidget(new Button(
                startX - 100, startY,
                200, 20,
                new TranslatableComponent("fluidlogged.config.fluids"),
        ...
        compatibilityModeButton = addRenderableWidget(CycleButton.onOffBuilder(compatibilityMode).create(
                ...
                200, 20,
                new TranslatableComponent("fluidlogged.config.compatibilityMode"),
                (button, value) -> {
        ...
        saveButton = addRenderableWidget(new Button(
                ...
                200, 20,
                new TranslatableComponent("fluidlogged.config.save"),
        ...
        addRenderableWidget(new Button(
                ...
                200, 20,
                new TranslatableComponent("fluidlogged.config.cancel"),
                button -> onClose()
        ));
    }
